...
1. **Validate the module exists** — `kamper/modules/<name>/` must be a directory. If not, abort with a clear error.
...
5. **Run `./gradlew :kamper:modules:<name>:jvmTest`** if Gradle commands are in the `.claude/settings.json` allowlist, and report pass/fail. (See `kamper-check` skill for the pre-approved command list.)
...
- [ ] Registered in `settings.gradle.kts` as `include(":kamper:modules:{name}")`
...
```
kamper/modules/{name}/src/commonMain/kotlin/com/smellouk/kamper/{name}/Module.kt
```

The 7 actual declarations live at:
```
kamper/modules/{name}/src/androidMain/kotlin/com/smellouk/kamper/{name}/Module.kt
kamper/modules/{name}/src/iosMain/kotlin/com/smellouk/kamper/{name}/Module.kt
kamper/modules/{name}/src/jvmMain/kotlin/com/smellouk/kamper/{name}/Module.kt
kamper/modules/{name}/src/macosMain/kotlin/com/smellouk/kamper/{name}/Module.kt
kamper/modules/{name}/src/tvosMain/kotlin/com/smellouk/kamper/{name}/Module.kt
kamper/modules/{name}/src/jsMain/kotlin/com/smellouk/kamper/{name}/Module.kt
kamper/modules/{name}/src/wasmJsMain/kotlin/com/smellouk/kamper/{name}/Module.kt
```
...
- `kamper/modules/cpu/` — canonical reference module; the gold-standard implementation
...
| Not in `settings.gradle.kts` | Add `include(":kamper:modules:{name}")` in alphabetical order in the modules block |
