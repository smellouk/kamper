...
actual object KonitorUi {
    ...
    private const val PREF_CHIP_Y = "konitor_chip_y"
    private const val PREF_ON_RIGHT = "konitor_on_right"
    ...
    /**
     * Public facade — attach overlay. iOS attach() takes no Context (UIApplication
     * provides root view controller). External consumers (Kotlin/Native ObjC bindings
     * from react-native-konitor iOS TurboModule) call this.
     */
    fun show() = attach()
