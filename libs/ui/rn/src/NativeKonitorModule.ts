// src/NativeKonitorModule.ts — Codegen TurboModule spec.
// Source of truth: generates Android NativeKonitorModuleSpec (Java abstract) +
// iOS NativeKonitorModuleSpecBase (ObjC++) + JSI glue.
...
export interface Spec extends TurboModule {
  ...
  // JS bridge write methods — push data from Hermes into Konitor
...
// Module name 'KonitorModule' MUST match Android `KonitorTurboModule.NAME`,
// iOS `+ moduleName`, and JS consumers' import key.
export default TurboModuleRegistry.getEnforcing<Spec>('KonitorModule');
