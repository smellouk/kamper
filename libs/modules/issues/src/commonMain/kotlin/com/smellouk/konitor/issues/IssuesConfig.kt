...
/**
 * Configuration for the slow-span detector. A "slow span" is a code region wrapped in a Konitor
 ...
 *
 * If your app already integrates Crashlytics, Sentry, or another crash reporter, Konitor logs a
 ...
 * @property chainToPreviousHandler If true, after Konitor handles the crash, delegate to the
 ...
 * Konitor [Issue] reports so they appear alongside other performance issues.
 *
