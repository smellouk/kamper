...
import com.smellouk.konitor.cpu.cinterop.KonitorCpuTicks
import com.smellouk.konitor.cpu.cinterop.konitor_fill_cpu_ticks
import com.smellouk.konitor.cpu.cinterop.konitor_get_logical_cpu_count
...
internal class MacosCpuInfoSource : CpuInfoSource {
    ...
    private val numCpus: Int by lazy { konitor_get_logical_cpu_count() }

    override fun getCpuInfoDto(): CpuInfoDto = memScoped {
        val ticks = alloc<KonitorCpuTicks>()
        if (konitor_fill_cpu_ticks(ticks.ptr) != 0) {
