 ...
 * @property forwardCpu When true, CpuInfo events become OTLP gauge `konitor.cpu.usage`.
 * @property forwardMemory When true, MemoryInfo events become OTLP gauge `konitor.memory.usage`.
 * @property forwardFps When true, FpsInfo events become OTLP gauge `konitor.fps.value`.
