...
class EngineIntegrationTest {
    ...
    private class RecordingIntegration(
        ...
        val received: MutableList<KamperEvent> = mutableListOf()
    ...
    // (b) D-02 — installed module emits KamperEvent on each Info update
    @Test
    fun `installed module fan-out invokes onEvent with KamperEvent carrying the Info`() {
