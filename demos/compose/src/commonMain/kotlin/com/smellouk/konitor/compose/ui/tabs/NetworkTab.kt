...
import com.smellouk.konitor.compose.performNetworkTest
...
fun NetworkTab(
    ...
    Column(modifier = modifier.fillMaxSize().padding(16.dp)) {
        ...
        if (downloadStatus.isNotEmpty()) {
            ...
            Text(text = downloadStatus, fontSize = 12.sp, color = KonitorColors.overlay1)
        }
