...
class JankViewController : UIViewController(nibName = null, bundle = null) {
    ...
    override fun viewDidLoad() {
        ...
        val notSupportedHint = hintLabel("Jank detection not available on tvOS")
        ...
        c += ratioLabel.topAnchor.constraintEqualToAnchor(unitLabel.bottomAnchor, constant = 48.0)
        ...
        c += worstLabel.topAnchor.constraintEqualToAnchor(ratioLabel.bottomAnchor, constant = 24.0)
        ...
        c += notSupportedHint.topAnchor.constraintEqualToAnchor(worstLabel.bottomAnchor, constant = 24.0)
        c += notSupportedHint.leadingAnchor.constraintEqualToAnchor(view.leadingAnchor, constant = pad)

        c += sep.topAnchor.constraintEqualToAnchor(notSupportedHint.bottomAnchor, constant = 24.0)
