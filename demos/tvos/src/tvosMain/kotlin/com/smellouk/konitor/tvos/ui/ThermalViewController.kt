...
class ThermalViewController : UIViewController(nibName = null, bundle = null) {
    ...
    override fun viewDidLoad() {
        ...
        bigLabel = UILabel().apply {
            text          = "N/A"
            font          = UIFont.monospacedSystemFontOfSize(100.0, weight = 0.7)
        ...
        c += throttlingLabel.topAnchor.constraintEqualToAnchor(unitLabel.bottomAnchor, constant = 48.0)
        ...
        c += simHintLabel.topAnchor.constraintEqualToAnchor(throttlingLabel.bottomAnchor, constant = 24.0)
        c += simHintLabel.leadingAnchor.constraintEqualToAnchor(view.leadingAnchor, constant = pad)

        c += sep.topAnchor.constraintEqualToAnchor(simHintLabel.bottomAnchor, constant = 24.0)
        ...
        c += stressBtn.topAnchor.constraintEqualToAnchor(sep.bottomAnchor, constant = 24.0)
