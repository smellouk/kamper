...
class GpuViewController : UIViewController(nibName = null, bundle = null) {
    ...
    override fun viewDidLoad() {
        ...
        val restrictedHint = hintLabel("GPU access restricted on tvOS — see ADR-007")
        ...
        c += memoryLabel.topAnchor.constraintEqualToAnchor(unitLabel.bottomAnchor, constant = 48.0)
        ...
        c += restrictedHint.topAnchor.constraintEqualToAnchor(memoryLabel.bottomAnchor, constant = 24.0)
