...
class MemoryViewController : UIViewController(nibName = null, bundle = null) {
    ...
    override fun viewDidLoad() {
        ...
        c += heapRow.topAnchor.constraintEqualToAnchor(heapLabel.bottomAnchor, constant = 12.0)
        ...
        c += heapDetail.topAnchor.constraintEqualToAnchor(heapRow.bottomAnchor, constant = 4.0)
        c += heapDetail.leadingAnchor.constraintEqualToAnchor(view.leadingAnchor, constant = pad)

        c += ramLabel.topAnchor.constraintEqualToAnchor(heapDetail.bottomAnchor, constant = 28.0)
        c += ramLabel.leadingAnchor.constraintEqualToAnchor(view.leadingAnchor, constant = pad)

        c += ramRow.topAnchor.constraintEqualToAnchor(ramLabel.bottomAnchor, constant = 12.0)
        ...
        c += ramDetail.topAnchor.constraintEqualToAnchor(ramRow.bottomAnchor, constant = 4.0)
        c += ramDetail.leadingAnchor.constraintEqualToAnchor(view.leadingAnchor, constant = pad)

        c += pssHint.topAnchor.constraintEqualToAnchor(ramDetail.bottomAnchor, constant = 16.0)
        c += pssHint.leadingAnchor.constraintEqualToAnchor(view.leadingAnchor, constant = pad)

        c += sep.topAnchor.constraintEqualToAnchor(pssHint.bottomAnchor, constant = 24.0)
        ...
        c += allocButton.topAnchor.constraintEqualToAnchor(sep.bottomAnchor, constant = 20.0)
        c += allocButton.trailingAnchor.constraintEqualToAnchor(freeButton.leadingAnchor, constant = -16.0)
        c += allocButton.centerYAnchor.constraintEqualToAnchor(freeButton.centerYAnchor)

        c += freeButton.topAnchor.constraintEqualToAnchor(sep.bottomAnchor, constant = 20.0)
