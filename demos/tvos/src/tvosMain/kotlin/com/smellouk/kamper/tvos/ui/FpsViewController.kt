...
class FpsViewController : UIViewController(nibName = null, bundle = null) {
    ...
    override fun viewDidLoad() {
        ...
        animView = AnimationView(CGRectMake(0.0, 0.0, 0.0, 400.0))
        ...
        c += fpsLabel.topAnchor.constraintEqualToAnchor(view.safeAreaLayoutGuide.topAnchor, constant = 48.0)
        ...
        c += unitLabel.topAnchor.constraintEqualToAnchor(fpsLabel.bottomAnchor, constant = 4.0)
        c += unitLabel.centerXAnchor.constraintEqualToAnchor(view.centerXAnchor)

        c += animView.topAnchor.constraintEqualToAnchor(unitLabel.bottomAnchor, constant = 32.0)
        ...
        c += animView.heightAnchor.constraintEqualToConstant(400.0)

        c += sep.topAnchor.constraintEqualToAnchor(animView.bottomAnchor, constant = 16.0)
        ...
        c += hintLabel.topAnchor.constraintEqualToAnchor(sep.bottomAnchor, constant = 16.0)
...
class AnimationView : UIView {
    ...
    override fun drawRect(rect: CValue<CGRect>) {
        ...
        for (i in palette.indices) {
            ...
            palette[i].setFill()
            UIBezierPath.bezierPathWithOvalInRect(CGRectMake(x - 28, y - 28, 56.0, 56.0)).fill()
        }
        for (i in palette.indices) {
        ...
        UIBezierPath.bezierPathWithOvalInRect(CGRectMake(cx - 10, cy - 10, 20.0, 20.0)).fill()
    }
}
