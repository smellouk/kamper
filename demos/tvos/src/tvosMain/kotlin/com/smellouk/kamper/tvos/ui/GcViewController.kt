...
class GcViewController : UIViewController(nibName = null, bundle = null) {
    ...
    override fun viewDidLoad() {
        ...
        bigLabel = UILabel().apply {
            text          = "—"
            font          = UIFont.monospacedSystemFontOfSize(160.0, weight = 0.7)
        ...
        arcHintLabel = hintLabel("tvOS uses ARC — no JVM GC")

        simulateTarget = ActionTarget { simulateGc() }
        val simulateBtn = makeButton("Simulate GC", simulateTarget)

        val sep = makeSeparator()
        listOf(bigLabel, unitLabel, pauseDeltaLabel, totalCountLabel, arcHintLabel, sep, simulateBtn)
            .forEach { view.addSubview(it) }

        val pad = 80.0
        val c = mutableListOf<NSLayoutConstraint>()

        c += bigLabel.topAnchor.constraintEqualToAnchor(view.safeAreaLayoutGuide.topAnchor, constant = 48.0)
        ...
        c += unitLabel.topAnchor.constraintEqualToAnchor(bigLabel.bottomAnchor, constant = 8.0)
        c += unitLabel.centerXAnchor.constraintEqualToAnchor(view.centerXAnchor)

        c += pauseDeltaLabel.topAnchor.constraintEqualToAnchor(unitLabel.bottomAnchor, constant = 48.0)
        ...
        c += totalCountLabel.topAnchor.constraintEqualToAnchor(pauseDeltaLabel.bottomAnchor, constant = 24.0)
        ...
        c += arcHintLabel.topAnchor.constraintEqualToAnchor(totalCountLabel.bottomAnchor, constant = 32.0)
        c += arcHintLabel.leadingAnchor.constraintEqualToAnchor(view.leadingAnchor, constant = pad)

        c += sep.topAnchor.constraintEqualToAnchor(arcHintLabel.bottomAnchor, constant = 24.0)
        ...
        c += simulateBtn.topAnchor.constraintEqualToAnchor(sep.bottomAnchor, constant = 24.0)
