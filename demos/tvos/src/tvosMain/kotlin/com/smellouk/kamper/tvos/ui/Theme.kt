...
object Theme {
    ...
    val HEADER_FONT = UIFont.boldSystemFontOfSize(36.0)!!
    val LABEL_FONT  = UIFont.systemFontOfSize(32.0)!!
    val MONO_FONT   = UIFont.monospacedSystemFontOfSize(32.0, weight = 0.0)!!
    val MONO_SMALL  = UIFont.monospacedSystemFontOfSize(26.0, weight = 0.0)!!
    val HINT_FONT   = UIFont.systemFontOfSize(26.0)!!
