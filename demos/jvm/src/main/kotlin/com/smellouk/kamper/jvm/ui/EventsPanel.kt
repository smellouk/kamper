...
class EventsPanel : JPanel(BorderLayout(0, 0)) {
    ...
    private fun buildFooter(): JPanel {
        ...
        loginBtn.addActionListener      { Kamper.logEvent("user_login") }
        purchaseBtn.addActionListener   { Kamper.logEvent("purchase") }
        screenViewBtn.addActionListener { Kamper.logEvent("screen_view") }
