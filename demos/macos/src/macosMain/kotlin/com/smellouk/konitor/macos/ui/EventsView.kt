...
class EventsView : NSView {
    ...
    private val loginTarget      = ActionTarget { Konitor.logEvent("user_login") }
    private val purchaseTarget   = ActionTarget { Konitor.logEvent("purchase") }
    private val screenViewTarget = ActionTarget { Konitor.logEvent("screen_view") }
