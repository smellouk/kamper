...
/**
 * Convention plugin that wires Maven publishing for Konitor library modules.
 *
 * Applied as: id("konitor.publish") in publishing modules' plugins{} block.
 *
 * This plugin is the verbatim migration of konitor/publish.gradle.kts (58 lines) into a
 * Plugin<Project> Kotlin class. Behavior preserved exactly — repository URLs, POM fields,
 * artifactId-rewrite rule for modules under konitor/modules/, credential sourcing from
 ...
 *
 * Credential loading (KONITOR_GH_USER / KONITOR_GH_PAT) is NOT done here. The root
 ...
 */
class KonitorPublishPlugin : Plugin<Project> {
    override fun apply(project: Project) {
        ...
        project.group = "com.smellouk.konitor"
            ...
            project.configure<PublishingExtension> {
                repositories {
                    if (System.getenv().containsKey("CI")) {
                        maven {
                            ...
                            credentials {
                                username = project.rootProject.extra["KONITOR_GH_USER"].toString()
                                password = project.rootProject.extra["KONITOR_GH_PAT"].toString()
                            }
                        }
                    }
                ...
                publications.withType<MavenPublication>().configureEach {
                    ...
                    pom {
                        ...
                        name.set("konitor:$projectName")
                        description.set(
                            "Konitor is small KMM/KMP library that provides performance monitoring for your app."
                        )
