...
import platform.darwin.if_data
    ...
    private fun readIfaddrs(): Pair<Long, Long>? = memScoped {
        ...
        while (ifa != null) {
            ...
            if (name != null && !name.startsWith("lo") &&
                ...
                ifa.pointed.ifa_data?.let { data ->
                    val ifData = data.reinterpret<if_data>().pointed
                    rx += ifData.ifi_ibytes.toLong()
                    tx += ifData.ifi_obytes.toLong()
                }
            }
